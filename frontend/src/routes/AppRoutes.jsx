...
import Cod_Remittance from "../pages/Seller/Billing/Remittance/cod_remittance";
    ...
    <>
      <SellerLayout>
        <Routes>
          ...
          <Route path="/cod_remittance" element={<Cod_Remittance />}>
            <Route index element={<Cod_Remittance />} />
          </Route>
