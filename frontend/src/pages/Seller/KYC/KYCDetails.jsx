                          ...
                          <div className="form-group ">
                            ...
                            {isSubmitted ? (
                              <img
                                height={100}
                                width={100}
                                src={`http://3.111.42.130:3001${dataList.documentFrontImage[0]}`}
                                alt=""
                              />
                            ) : (
                              <input
                        ...
                        <div className="form-group ">
                          ...
                          {isSubmitted ? (
                            <img
                              height={100}
                              width={100}
                              src={`http://3.111.42.130:3001${dataList.partnershipDeedImage[0]}`}
                              alt=""
                            />
                          ) : (
                            <input
                          ...
                          <div className="form-group ">
                            ...
                            {isSubmitted ? (
                              <img
                                height={100}
                                width={100}
                                src={`http://3.111.42.130:3001${dataList.gstImage[0]}`}
                                alt=""
                              />
                            ) : (
                              <input
                          ...
                          <div className="form-group ">
                            ...
                            {isSubmitted ? (
                              <img
                                height={100}
                                width={100}
                                src={`http://3.111.42.130:3001${dataList.documentBackImage[0]}`}
                                alt=""
                              />
                            ) : (
                              <input
