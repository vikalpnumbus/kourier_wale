            ...
            <main>
                ...
                <div className="kpi-strip">
                    <div className="kpi-card">
                        <div className="kpi-card-accent" style={{ background: "linear-gradient(90deg, #3D6BFF, #6B7AFF);"}}></div>
                        ...
                        <div className="kpi-icon-bg" style={{color: "#3D6BFF"}}>COD</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-card-accent" style={{background: "linear-gradient(90deg, #2D8A4E, #48d984);"}}></div>
                        ...
                        <div className="kpi-icon-bg" style={{color:"#2D8A4E"}}>PAID</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-card-accent" style={{background: "linear-gradient(90deg, #F5A623, #ffd580);"}}></div>
                        ...
                        <div className="kpi-icon-bg" style={{color:"#F5A623"}}>FAST</div>
                    </div>
                    <div className="kpi-card">
                        <div className="kpi-card-accent" style={{background: "linear-gradient(90deg, #6B7AFF, #3D6BFF);"}}></div>
                        ...
                        <div className="kpi-icon-bg" style={{color:"#6B7AFF"}}>7D</div>
                    </div>
                </div>
                <div className="early-cod-banner">
                    ...
                    <div className="banner-cta">
                        <button className="btn" style={{background:"#C8830E",color:"#fff",boxShadow:"0 4px 12px rgba(200,131,14,0.3)",height:"34px",fontSize:"0.78rem"}}>
                ...
                <div className="filters-bar">
                    ...
                    <div className="filter-divider"></div>
                    <button className="btn btn-ghost" style={{height:"34px",fontSize:"0.75rem",padding:"0 0.875rem"}}>
